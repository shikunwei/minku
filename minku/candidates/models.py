...
class Candidate(models.Model):
    # 基本信息
    basic_username = models.CharField(max_length=128, verbose_name=u'姓名')
    basic_user_status = models.CharField(max_length=128, blank=True, verbose_name=u'目前状态')
    basic_gender = models.CharField(max_length=128, choices=GENDER, blank=True, verbose_name=u'性别')
    basic_born_year = models.CharField(max_length=128, blank=True, null=True, verbose_name=u'出生年份')
    basic_age = models.IntegerField(default=0, verbose_name=u'年龄')
    basic_residence_city = models.CharField(max_length=128, blank=True, verbose_name=u'户籍')
    basic_phone = models.CharField(max_length=128, blank=True, null=True, verbose_name=u'手机号码')
    basic_email = models.EmailField(max_length=128, blank=True, null=True, verbose_name=u'邮箱')
    basic_marriage_status = models.CharField(max_length=128, choices=MARRIAGE_STATUS, blank=True, verbose_name=u'婚姻状况')
    basic_work_start_year = models.CharField(max_length=128, blank=True, null=True, verbose_name=u'参加工作时间')
    basic_work_years = models.IntegerField(default=0, verbose_name=u'工作年限')
    # 学历信息
    basic_edu_degree = models.CharField(max_length=128, choices=DEGREE_TYPE, blank=True, verbose_name=u'学历')
    ...
    # 工作信息
    work_industry = models.CharField(max_length=128, blank=True, verbose_name=u'行业')
    work_city = models.CharField(max_length=128, blank=True, verbose_name=u'工作城市')
    work_company = models.CharField(max_length=256, blank=True, verbose_name=u'公司名称')
    work_position = models.CharField(max_length=256, blank=True, verbose_name=u'职位名称')
    work_salary = models.CharField(max_length=128, blank=True, verbose_name=u'年薪')
    work_salary_structure = models.CharField(max_length=512, blank=True, verbose_name=u'薪资结构')
    work_intention = models.CharField(max_length=256, choices=WORK_INTENTION, blank=True, verbose_name=u'工作意向')
    # 期望工作
    expect_industry = models.CharField(max_length=256, blank=True, verbose_name=u'期望行业')
    expect_city = models.CharField(max_length=128, blank=True, verbose_name=u'期望城市')
    expect_position = models.CharField(max_length=256, blank=True, verbose_name=u'期望职位')
    expect_salary = models.CharField(max_length=128, blank=True, verbose_name=u'期望年薪')
    # 自我评价
    ...
    class Meta:
        ...
        unique_together = ('basic_username', 'basic_phone')
...
class EduRecords(models.Model):
    ...
    edu_degree_value = models.CharField(max_length=128, choices=DEGREE_VALUE_TYPE, blank=True, verbose_name=u'学校性质')
    candidate = models.ForeignKey(to=Candidate, on_delete=models.CASCADE)

    # 录入者信息
    edu_creator = models.CharField(max_length=32, blank=True, verbose_name=u'候选人数据的创建人')
    edu_created_date = models.DateTimeField(auto_now_add=True, verbose_name=u'创建时间')
    edu_modified_date = models.DateTimeField(auto_now=True, null=True, blank=True, verbose_name=u'更新时间')
    edu_last_editor = models.CharField(max_length=32, blank=True, verbose_name=u'最后编辑者')
...
class CompanyRecords(models.Model):
    ...
    # 录入者信息
    work_creator = models.CharField(max_length=32, blank=True, verbose_name=u'候选人数据的创建人')
    work_created_date = models.DateTimeField(auto_now_add=True, verbose_name=u'创建时间')
    work_modified_date = models.DateTimeField(auto_now=True, null=True, blank=True, verbose_name=u'更新时间')
    work_last_editor = models.CharField(max_length=32, blank=True, verbose_name=u'最后编辑者')
...
class ProjectRecords(models.Model):
    ...
    # 录入者信息
    project_creator = models.CharField(max_length=32, blank=True, verbose_name=u'候选人数据的创建人')
    project_created_date = models.DateTimeField(auto_now_add=True, verbose_name=u'创建时间')
    project_modified_date = models.DateTimeField(auto_now=True, null=True, blank=True, verbose_name=u'更新时间')
    project_last_editor = models.CharField(max_length=32, blank=True, verbose_name=u'最后编辑者')
...
class Comments(models.Model):
    ...
    # 录入者信息
    comment_creator = models.CharField(max_length=32, blank=True, verbose_name=u'候选人数据的创建人')
    comment_created_date = models.DateTimeField(default=timezone.now, verbose_name=u'创建时间')
    comment_modified_date = models.DateTimeField(auto_now=True, null=True, blank=True, verbose_name=u'备注时间')
    comment_last_editor = models.CharField(max_length=32, blank=True, verbose_name=u'最后编辑者')
