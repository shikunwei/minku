...
## Migrate databases
`docker-compose run --rm djangoapp minku/manage.py migrate` or `make migrate`.

## Collect static files
`docker-compose run --rm djangoapp minku/manage.py collectstatic --no-input'` or `make collectstatic`.
